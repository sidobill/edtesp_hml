...
{
    public class EdtespRepositoryBase<TEntity> : IEdtespRepositoryBase<TEntity>, IDisposable where TEntity : class
    {
        internal readonly IEdtespContexto context;
        internal IDbSet<TEntity> dbSet;

        private bool _disposed;

        public EdtespRepositoryBase(IEdtespContexto contexto)
        {
            context = contexto;
